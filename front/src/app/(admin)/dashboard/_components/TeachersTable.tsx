              ...
              {data.map((t) => (
                <div key={t.id} className="px-4 py-3 flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-3 shrink-0 text-right">
                    <div>
                      <p className="text-[10px] text-gray-400">Уроків</p>
                      <p className="text-sm font-medium tabular-nums">{t.lessonsCount}</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-gray-400">Зароблено</p>
                      <p className="text-sm font-medium tabular-nums">{formatCurrency(t.earned)}</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-gray-400">Учнів</p>
                      <p className="text-sm font-medium tabular-nums">{t.childrenCount}</p>
                    </div>
                  </div>
                </div>
              ))}
